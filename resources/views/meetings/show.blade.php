        ...
        <fieldset disabled>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="disabledTextInput" value="{{ $m->publicacion->solicitud->familiaBiologica }}"
                        class="form-control">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="disabledTextInput" value="{{ $m->publicacion->solicitud->descripcionSalud }}"
                        class="form-control">
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="disabledTextInput" value="{{ $m->publicacion->solicitud->descripcion }}"
                        class="form-control">
                </div>
                <div class="form-group col-md-6">
