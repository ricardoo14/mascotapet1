                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="segundoNombre" type="text" class="form-control @error('segundoNombre') is-invalid @enderror" name="segundoNombre" value="{{ old('segundoNombre') }}" required autocomplete="segundoNombre" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="fechaDeNacimiento" class="col-md-4 col-form-label text-md-right">{{ __('Fecha de nacimiento') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="resenaPersonal" class="col-md-4 col-form-label text-md-right">{{ __('Reseña personal') }}</label>

                            <div class="col-md-6">
                                <input id="resenaPersonal" type="text" class="form-control @error('resenaPersonal') is-invalid @enderror" name="resenaPersonal" value="{{ old('resenaPersonal') }}" required autocomplete="resenaPersonal" autofocus>
