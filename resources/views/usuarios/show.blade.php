        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <a href="{{ url('/usuarios') }}"><button type="button"
                ...
                <form>
                    <div class="row justify-content-center">
                        <div class="col-lg-4">
                            <div class="p-5"><img class="img-fluid rounded-circle" src="{{ asset('images/' . $user->avatar) }}"
                                    alt="" /></div>
                        </div>
                    </div>
                    ...
                    <fieldset disabled>
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $user->segundoNombre }}"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $user->apellido }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="disabledTextInput" class="form-label">Segundo apellido</label>
                                <input type="text" id="disabledTextInput" value="{{ $user->segundoApellido }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $user->telefono }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $user->direccion }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="disabledTextInput" class="form-label">Ciudad</label>
                                <input type="text" id="disabledTextInput" value="{{ $user->ciudad }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $user->region }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="disabledTextInput" class="form-label">Reseña personal</label>
                                <input type="text" id="disabledTextInput" value="{{ $user->resenaPersonal }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                        </div>
