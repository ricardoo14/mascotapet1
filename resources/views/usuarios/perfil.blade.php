            ...
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    <div class="p-5"><img class="img-fluid rounded-circle"
                            src="{{ asset('images/' . Auth::user()->avatar) }}" alt="" /></div>
                </div>
            </div>
            ...
            <fieldset disabled>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $use->segundoNombre }}"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $use->apellido }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="disabledTextInput" class="form-label">Segundo apellido</label>
                                <input type="text" id="disabledTextInput" value="{{ $use->segundoApellido }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $use->telefono }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $use->direccion }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $use->resenaPersonal }}"
                                    class="form-control" placeholder="Disabled input">
                            </div>
                        </div>
                    </div>
