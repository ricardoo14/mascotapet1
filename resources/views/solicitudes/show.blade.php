                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4">
                            <div class="p-5"><img class="img-fluid rounded-circle"
                                    src="{{ asset('imagenes/' . $s->imagen) }}" alt="{{ $s->imagen }}"></div>
                        </div>
                    </div>
                    ...
                    <fieldset disabled>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $s->created_at }}"
                                    class="form-control">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $s->descripcion }}"
                                    class="form-control">
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="disabledTextInput" value="{{ $s->estadoSolicitud->estadoSolicitud }}"
                                    class="form-control">
                            </div>
                        </div>
                    </fieldset>
